...
var getButtonTextColor = function () { return function (_a) {
    _a.theme; var _b = _a.variant, variant = _b === void 0 ? variants$1.PRIMARY : _b;
    if (variant === variants$1.TERTIARY || variant === variants$1.SECONDARY || variant === variants$1.TEXT)
        return 'white';
    return 'rgb(32 32 32)';
}; };
...
var getThemeTextColor = function (_a) {
    ...
    return outline ? getColor(variant, theme) : "#fbce98";
};
...
var ChainContainer = styled__default['default'].div(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  display: flex;\n  margin-bottom: 0;\n  margin-top: auto;\n  justify-content: center;\n  padding: 20px 0;\n"], ["\n  display: flex;\n  margin-bottom: 0;\n  margin-top: auto;\n  justify-content: center;\n  padding: 20px 0;\n"])));
var ChainLogo = styled__default['default'].img(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  height: 30px;\n"], ["\n  height: 30px;\n"])));
